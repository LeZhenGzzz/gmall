...
public class CodeGenerator {
    ...
    public static void main(String[] args) {
        ...
        gc.setOutputDir("E:\\devWork\\gmallparent\\gmall-mbg" + "/src/main/java");
        gc.setAuthor("datou");
        ...
        dsc.setUrl("jdbc:mysql://192.168.0.114:3307/gmall_"+moduleName+"?useUnicode=true&useSSL=false&characterEncoding=utf8");
